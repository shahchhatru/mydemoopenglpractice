...
{ //     COORDINATES     /        COLORS      /   TexCoord  //
	...
	-0.5f, 0.0f, -0.5f,     0.83f, 0.70f, 0.44f,	//5.0f, 0.0f,
	 0.5f, 0.0f, -0.5f,     0.90f, 0.00f, 0.44f,	//0.0f, 0.0f,
	 0.5f, 0.0f,  0.5f,     0.00f, 0.70f, 0.44f,	//5.0f, 0.0f,
...
int main()
{
	//string infix = "x*y+e(x*x)/10-e(x*y)/10+e(y*y)/10";
	//string infix = "x*y+e(x*x)/10-e(x*y)/10+e(y*y)/10 +cos(x*y)/10";
	//string infix = "x/10-y+1/10";
	//string infix = "1/10-x*x*sin(y*y)/5+y*cos(x*x*x)/10+x*y";
	//string infix = "x*x/y+y*y/x";
	string infix;
	char flag='y';
	while (flag == 'y') {
		...
		*/
		...
		glfwTerminate();
		std::cout << "do you want to enter more eqn (y/n)" << std::endl;
		std::cin >> flag;
	}
	return 0;
}